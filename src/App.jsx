...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 relative overflow-hidden">
      ...
      {/* Header */}
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'shadow-md bg-white' : 'bg-transparent'} py-4`}>
        <div className="container mx-auto px-4">
          <div className="flex items-center">
            ...
            />
            <span className="font-extrabold text-2xl md:text-3xl tracking-tight text-blue-600">
              AIRSTREAM
            </span>
          </div>
        </div>
